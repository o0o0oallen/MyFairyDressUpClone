!function (e, t) {
    ...
    (P = r = r || {})[P.INTERSTITIAL = 0] = "INTERSTITIAL",
        P[P.REWARDED_VIDEO = 1] = "REWARDED_VIDEO",
        P[P.BANNER = 2] = "BANNER",
        (t = o = o || {})[t.NONE = 0] = "NONE",
        t[t.NEW = 1] = "NEW",
    ...
    class D {
        constructor(e, t, i, s) {
            this._maxLoadError = 0,
                ...
                this._maxLoadError = w(s, "maxLoadError", 0)
        }
        getStateName() {
            return function (e) {
                let t = "NONE";
    ...
    class O extends D {
        constructor(e, t, i, s) {
            super(e, t, i, s),
                ...
                this._autoLoadOnPlay = w(s, "autoLoadOnPlay", !1)
        }
        loadAsync() {
            return n(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    e.code === E ? (console.info("Ads Not Fill, stop loading: " + this.getInfo()),
        ...
        showAsync() {
            return n(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    e.code === y ? this._state = o.LOADED : (this._adInstance = null,
                        this._state = o.NONE,
                        this._autoLoadOnPlay && (console.log("Reload after 1 seconds: " + this.getInfo()),
                            this.safeReLoadAsync(1))),
                    e
        ...
        showAsync() {
            return n(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    e.code === y ? this._state = o.NONE : e.code === E ? (console.info("Ads Not Fill, Stop: " + this.getInfo()),
                        this.setFatalError()) : (this.increaseErrorCounter(),
                            this._state = o.NONE),
                    e
                }
    ...
    v._interstitialAds = [],
        v._rewardedVideos = [],
        v._banners = [],
        v._interstitialTimer = null,
        v._rewardedVideoTimer = null,
        v._bannerTimer = null,
        v._bannerSupport = void 0,
        v._fb_max_ad_instance = 1,
        v._fb_init_ad_count = 1,
        v.defaultInterstitialOption = {
            autoLoadOnPlay: !0,
            maxLoadError: 3
        },
        ...
        load(e) {
            try {
                ...
                this._test = e.isTest,
                    ...
                    v.initAdOption(t);
                var i = e.config;
                v.addBanner(i.banner),
                    v.addInterstitial(i.interstitial),
                    v.addRewardedVideo(i.rewarded_video),
                    v.loadAllAsync()
            } catch (e) {
    ...
    t = {
        ...
        initializeAsync: function (i) {
            return n(this, void 0, void 0, function* () {
                ...
                return console.info("minigame loader inited..."), Promise.resolve()
                    /*t.features && t.features.ads ? (p.load(t.features.ads),
                        window.MiniGameAds = p,
                        Promise.resolve()) : (console.info("missing features or missing ads"),
                            Promise.reject({
    ...
    console.info("minigame sdk: " + t.version),
        window.FBInstant = t,
        window.minigame = t,
        e.MINIGAME_PLATFORM = P,
        e.MINIGAME_DEFAULT_CONFIG = B,
        e.loadConfigAsync = S,
        e.loadPlatformAndInitAsync = F,
        e.minigameLoader = t,
